...
BOOST_AUTO_TEST_CASE(link_auths) { try {
   ...
   chain.link_authority("alice", "eonio", "spending",  "reqauth");
   ...
   BOOST_CHECK_THROW( chain.link_authority("alice", "eonio", "spending",  "reqauth"), action_validate_exception);

   // Unlink alice with eosio reqauth
   chain.unlink_authority("alice", "eonio", "reqauth");
   ...
   chain.link_authority("alice", "eonio", "scud");
...
BOOST_AUTO_TEST_CASE(link_then_update_auth) { try {
   ...
   chain.link_authority("alice", "eonio", "first",  "reqauth");
