...
const static uint64_t system_account_name    = N(eonio);
const static uint64_t null_account_name      = N(eonio.null);
const static uint64_t producers_account_name = N(eonio.prods);
...
const static uint64_t eosio_auth_scope       = N(eonio.auth);
const static uint64_t eosio_all_scope        = N(eonio.all);

const static uint64_t active_name = N(active);
const static uint64_t owner_name  = N(owner);
const static uint64_t eosio_any_name = N(eonio.any);
const static uint64_t eosio_code_name = N(eonio.code);
