...
void validate_authority_precondition( const apply_context& context, const authority& auth ) {
   for(const auto& a : auth.accounts) {
      ...
      if( a.permission.permission == config::eosio_code_name ) // virtual eonio.code permission does not really exist but is allowed
         continue;
 ...
 */
void apply_eonio_newaccount(apply_context& context) {
...
void apply_eonio_setcode(apply_context& context) {
...
void apply_eonio_setabi(apply_context& context) {
   auto& db  = context.db;
...
void apply_eonio_updateauth(apply_context& context) {
...
void apply_eonio_deleteauth(apply_context& context) {
//   context.require_write_lock( config::eosio_auth_scope );
...
void apply_eonio_linkauth(apply_context& context) {
//   context.require_write_lock( config::eosio_auth_scope );
...
void apply_eonio_unlinkauth(apply_context& context) {
//   context.require_write_lock( config::eosio_auth_scope );
...
void apply_eonio_canceldelay(apply_context& context) {
