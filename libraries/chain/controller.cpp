...
#define SET_APP_HANDLER( receiver, contract, action) \
   ...
   SET_APP_HANDLER( eonio, eonio, newaccount );
   SET_APP_HANDLER( eonio, eonio, setcode );
   SET_APP_HANDLER( eonio, eonio, setabi );
   SET_APP_HANDLER( eonio, eonio, updateauth );
   SET_APP_HANDLER( eonio, eonio, deleteauth );
   SET_APP_HANDLER( eonio, eonio, linkauth );
   SET_APP_HANDLER( eonio, eonio, unlinkauth );
/*
...
*/
   ...
   SET_APP_HANDLER( eonio, eonio, canceldelay );
